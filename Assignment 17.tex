...
\begin{abstract}
This assignment deals with algebra of polynomials.
\end{abstract}
Download  tex file from 
\begin{lstlisting}
https://github.com/satyam463/Assignment-17/blob/main/Assignment%2017.tex
\end{lstlisting}
...
\end{align}
 ...
 \begin{align}
     \vec{A}^{2}-5\vec{A}+7=0\\
     \vec{A}^{2}=5\vec{A}-7\vec{I}\label{1}
 \end{align}
The given polynomial 
 \begin{align}
     f\brak{x}=x^{2}-x+2\\
     f\brak{\vec{A}}=\vec{A}^{2}-\vec{A}+2\vec{I}\label{2}
 \end{align}
 substituting \refeq{1} in \refeq{2} we get
 \begin{align}
